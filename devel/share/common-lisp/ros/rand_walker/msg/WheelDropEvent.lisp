...
(cl:defmethod cl:initialize-instance :after ((m <WheelDropEvent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WheelDropEvent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rand_walker-msg:<WheelDropEvent> is deprecated: use rand_walker-msg:WheelDropEvent instead.")))

(cl:ensure-generic-function 'wheel-val :lambda-list '(m))
(cl:defmethod wheel-val ((m <WheelDropEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rand_walker-msg:wheel-val is deprecated.  Use rand_walker-msg:wheel instead.")
  (wheel m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WheelDropEvent>)))
  ...
  (cl:format cl:nil "# wheel~%uint8 LEFT  = 0~%uint8 RIGHT = 1~%~%# state~%uint8 RAISED  = 0~%uint8 DROPPED = 1~%~%uint8 wheel~%uint8 state~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WheelDropEvent)))
  "Returns full string definition for message of type 'WheelDropEvent"
  (cl:format cl:nil "# wheel~%uint8 LEFT  = 0~%uint8 RIGHT = 1~%~%# state~%uint8 RAISED  = 0~%uint8 DROPPED = 1~%~%uint8 wheel~%uint8 state~%~%~%"))
