...
(cl:defmethod cl:initialize-instance :after ((m <Led>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Led)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rand_walker-msg:<Led> is deprecated: use rand_walker-msg:Led instead.")))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <Led>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rand_walker-msg:value-val is deprecated.  Use rand_walker-msg:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Led>)))
  ...
  (cl:format cl:nil "uint8 BLACK   = 0~%uint8 GREEN   = 1~%uint8 ORANGE  = 2~%uint8 RED     = 3~%~%uint8 value~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Led)))
  "Returns full string definition for message of type 'Led"
  (cl:format cl:nil "uint8 BLACK   = 0~%uint8 GREEN   = 1~%uint8 ORANGE  = 2~%uint8 RED     = 3~%~%uint8 value~%~%~%"))
